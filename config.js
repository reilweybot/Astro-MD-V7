...
INBOX_BL_MSG: process.env.INBOX_BL_MSG === undefined ? '_*Inbox not allowed*_' : process.env.INBOX_BL_MSG,
HOST: process.env.HOST === undefined ? '-' : process.env.HOST,
SESSION_ID: process.env.SESSION_ID === undefined ? 'ASTRO=t75glbiJ#iON5qvH-8Ao_qhuXVg1T7iT0ZOelOJw_8_d0hrRvH2w' : process.env.SESSION_ID
};
